...
SPOTS_DATA = [
    ...
    {"name": "ミスタードーナツ 杉田ショップ", "station": "杉田", "lat": 35.3815, "lon": 139.6205, "category": "カフェ", "wifi": True, "power": False, "access": "杉田駅直結 Plat杉田内", "desc": "京急杉田駅直結。適度な賑やかさがあり、リラックスして勉強できます。"},
