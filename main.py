...
def load_spots_dataframe() -> pd.DataFrame:
    ...
    spots_data = [
        ...
        # --- 復活した戸塚・上大岡・二俣川・鶴見・東神奈川・文庫のカフェデータ ---
        ...
        {"name": "タリーズコーヒー 京急富岡周辺", "station": "京急富岡", "line": "京急本線", "lat": 35.3650, "lon": 139.6320, "category": "カフェ", "wifi": True, "power": True, "seats": "広域対応", "rule": "特になし", "access": "京急富岡エリア", "desc": "近近隣エリアの勉強・作業スペースとして貴重なインフラ。"},
        ...
        {"name": "スターバックスコーヒー 菊名店", "station": "妙蓮寺", "line": "東急東横線", "lat": 35.5095, "lon": 139.6312, "category": "カフェ", "wifi": True, "power": True, "seats": "駅チカ大型", "rule": "混雑時利用制限", "access": "妙蓮寺・菊名隣駅エリア", "desc": "隣駅の菊名駅ビル内。充実した電源席と安定したWi-Fiで作業が最も捗る。"},
